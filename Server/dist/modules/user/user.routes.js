...
router.post("/verify-otp", (0, publicRateLimit_1.publicRateLimit)({ windowMs: 5 * 60 * 1000, maxRequests: 10 }), userController.verifyOtp);
router.post("/logout", userController.logout);
// Protected Routes
router.use(user_middleware_1.authenticateUser);
