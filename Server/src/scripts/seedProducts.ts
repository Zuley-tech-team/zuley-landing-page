...
const products = [
  // Silver Pens
  {
    ...
    description:
      "Handcrafted 925 sterling silver pen with personalized engraving option",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Elegant fountain pen with smooth ink flow and premium silver finish",
    longDescription:
      "The Classic Fountain Pen combines timeless elegance with modern precision. Its 18K gold nib ensures smooth, consistent ink flow while the sterling silver body provides the perfect weight balance for extended writing sessions.",
    features: [
  ...
  },
  {
    ...
    longDescription:
      "A perfect balance of luxury and practicality, the Premium Ballpoint is designed for professionals who want to make a statement. Its reliable ballpoint mechanism ensures effortless writing every time.",
    badge: "New",
    features: [
  ...
  },
  {
    ...
    description:
      "Limited edition pen with intricate silver engravings and vintage design",
    longDescription:
      "The Heritage Collection Pen is a masterpiece of artisanal craftsmanship. Featuring hand-engraved patterns inspired by traditional Indian motifs, this limited edition piece is numbered and comes with a heritage certificate.",
  ...
  },
  {
    ...
    longDescription:
      "Clean lines and understated elegance define the Modern Minimalist Pen. Its brushed silver finish and contemporary design make it perfect for the modern professional who values simplicity.",
    features: [
  ...
  // Silver Phone Covers
  {
    ...
    longDescription:
      "Protect your device in style with the Classic Silver Case. Featuring genuine sterling silver accents and military-grade shock absorption, this case offers the perfect blend of luxury and protection.",
    badge: "Bestseller",
    features: [
  ...
  },
  {
    ...
    description:
      "Personalized phone case with your initials in sterling silver",
    longDescription:
      "Make your phone uniquely yours with the Engraved Monogram Case. Your initials are hand-engraved in sterling silver, creating a one-of-a-kind accessory that reflects your personal style.",
    badge: "New",
    features: [
  ...
  },
  {
    ...
    longDescription:
      "The Platinum Shield Case offers uncompromising protection without sacrificing style. Its reinforced corners and platinum-finished silver trim make it the choice for those who demand the best.",
    features: [
  ...
  },
  {
    ...
    longDescription:
      "The epitome of luxury phone protection. Handcrafted from genuine Italian leather with sterling silver hardware, this case ages beautifully and develops a unique patina over time.",
    badge: "Limited Edition",
    features: [
...
async function seedProducts() {
  try {
    ...
    console.log(`Seeded inventory for ${inventoryItems.length} products`);
