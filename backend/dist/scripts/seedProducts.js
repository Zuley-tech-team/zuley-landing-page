...
function seedProducts() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Insert products
            const insertedProducts = yield product_model_1.Product.insertMany(products);
            ...
            yield inventory_model_1.Inventory.deleteMany({});
            console.log("Cleared existing inventory");
            yield inventory_model_1.Inventory.insertMany(inventoryItems);
